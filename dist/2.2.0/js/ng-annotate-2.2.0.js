    ...
    return {
      ...
      compile: function(tElement, tAttrs, transclude) {
        return function($scope, element, attrs) {
          var activePopup, activeTooltip, clearPopup, clearTooltip, createAnnotation, loadAnnotationPopup, onAnnotationsChange, onClick, onMouseEnter, onMouseLeave, onSelect, options, popupTemplateData, removeAnnotation, removeChildren, tooltipTemplateData;
          activePopup = null;
          activeTooltip = null;
          popupTemplateData = "";
          tooltipTemplateData = "";
          ...
          return element.on("mouseup", function(event) {
            ...
            if (selection.type === "Range" && !options.readonly) {
